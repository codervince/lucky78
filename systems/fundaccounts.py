...
class FundAccount(object):
    ...
    '''
    def __init__(self,currency, nosystems, jratio, tratio, miratio, sratio,description,year, fundname="", bettingratio=D('0.05'), performancefee=D('0.10'), performancethreshold=D('1.5'), managementfee =D('0.05'), bailoutfee=D(0.25), paysDividends=True,
